...
* Install [BepInEx 5](https://github.com/bepinex/bepinex/releases) into the game folder and launch the game once.
* Download the zip file from the [Releases](https://github.com/dot-alonso/MadOutLegacy/releases) section and extract it into the game root folder.
...
1. Install [BepInEx 5](https://github.com/bepinex/bepinex/releases) into the game folder and launch the game once.
